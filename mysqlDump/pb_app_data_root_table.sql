...
CREATE TABLE `root_table` (
  ...
  `rootUserName` varchar(65) DEFAULT NULL,
  `root_PW` varchar(65) DEFAULT NULL,
  PRIMARY KEY (`root_id`)
...
INSERT INTO `root_table` VALUES ('rt2021','rootUser','user@2021');
...
-- Dump completed on 2022-01-03  9:38:07
